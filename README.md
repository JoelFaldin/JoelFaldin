...
* 🌍 `I live in:` Chile! 🇨🇱🇨🇱🇨🇱
* 🔭 `Working on:` Refactoring a React+Vite e-commerce repo (Visit it [here](https://github.com/IgnacioBarraza/BlackSharkWeb)!). Learning new stuff at FullStackOpen, and trying out NeoVim!!!
